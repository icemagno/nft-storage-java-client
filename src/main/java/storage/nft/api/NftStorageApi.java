...
public class NftStorageApi {
     ...
     */
    public String list(OffsetDateTime before, Integer limit) throws ApiException {
        return listWithHttpInfo(before, limit);
     ...
     */
    public String listWithHttpInfo(OffsetDateTime before, Integer limit) throws ApiException {
    	try {
     ...
     */
    public String status(String cid) throws ApiException {
        //ApiResponse<GetResponse> localVarResp = statusWithHttpInfo(cid);
        return statusWithHttpInfo(cid);
    }
     ...
     */
    public String statusWithHttpInfo(String cid) throws ApiException {
     ...
     */
    public String store(File body) throws ApiException {
        return storeWithHttpInfo(body);
    }
     ...
     */
    public String storeWithHttpInfo(File body) throws ApiException {
    	try {
	        okhttp3.Call localVarCall = storeValidateBeforeCall(body, null);
	        return localVarCall.execute().body().string();
    	} catch( Exception e ) {
    		throw new ApiException( e.getMessage() );
    	}
    }
     ...
     */
    public okhttp3.Call storeAsync(File body, final ApiCallback<String> _callback) throws ApiException {
