...
import okio.Okio;
import storage.nft.auth.ApiKeyAuth;
import storage.nft.auth.Authentication;
import storage.nft.auth.HttpBasicAuth;
import storage.nft.auth.HttpBearerAuth;

public class ApiClient {

    private String basePath = "https://api.nft.storage";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.nft.storage
    ...
    public <T> void executeAsync(Call call, final Type returnType, final ApiCallback<T> callback) {
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                T result;
                try {
                    result = (T) response.body().string();  //handleResponse(response, returnType);
                } catch (Exception e) {
